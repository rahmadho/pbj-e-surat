...
--
-- Host: localhost:3306
-- Generation Time: Jul 24, 2025 at 03:41 PM
...
INSERT INTO `m_dispos` (`id_dispos`, `id_leader`, `nama_bagian`) VALUES
(1, 9, 'Bagian PBJ'),
(2, 11, 'Bagian LPSE'),
(8, 12, 'Bagian Advokasi'),
(9, 13, 'Bagian Subag SDM');
...
INSERT INTO `tb_agenda` (`id`, `id_surat`, `tgl_agenda`, `waktu_agenda`, `tempat_agenda`, `keterangan`, `file_laporan`, `file_foto`) VALUES
(1, 0, '2025-07-28', '08:00:00', 'dpr', NULL, NULL, NULL),
(2, 0, '2025-07-28', '08:30:00', 'DPR', NULL, NULL, NULL),
(3, 19, '2025-07-28', '08:30:00', 'DPR', NULL, NULL, NULL),
(4, 20, '2025-07-29', '10:00:00', 'DPR', NULL, NULL, NULL);
...
INSERT INTO `tb_disposisi` (`id`, `id_surat_masuk`, `no_surat`, `tgl_surat`, `tanggal_terima`, `asal_surat`, `sifat_surat`, `perihal`, `no_agenda`, `teruskan`, `ket`, `sifat_dispos`, `batas`, `indeks`, `kode_surat`, `tujuan`) VALUES
(24, 0, '1', '2021-02-16', '2021-02-16', '3', 'sp', 'pengumuman', '0001', '2', 'Tolong segera di proses ya', 'Penting', '2021-02-20', '12', 11, 4),
(27, 19, '081-1210/uk-2025', '2025-07-23', '2025-07-23', '2', 'b', 'Undangan', '0001', '1', 'Laksanakan', 'Penting', '2025-07-26', '1', 1, 4);

-- --------------------------------------------------------

--
-- Table structure for table `tb_history_surat_masuk`
--

CREATE TABLE `tb_history_surat_masuk` (
  `id` int(11) NOT NULL,
  `id_surat_masuk` int(11) NOT NULL,
  `keterangan` text NOT NULL,
  `created_at` timestamp NOT NULL,
  `id_user_aksi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
('Provinsi Sumatera Barat', 'Biro Pengadaan Barang dan Jasa', 'Jl. Sudirman no 51', '081214600799', 'sumbar.png');
...
(11, '1', '2021-02-16', 3, 'Sangat Penting', 'daftar inventaris kantor', '0001', 264, 'awal bayar indihome.jpg', 0, '2021'),
(12, '1', '2021-03-12', 3, 'Biasa', 'asdasdasdasdasd', '0002', 1, '1.1.jpg', 4, '2021');
...
CREATE TABLE `tb_surat_masuk` (
  ...
  `tujuan` int(11) NOT NULL,
  `kode_surat` int(11) NOT NULL,
  `undangan` double NOT NULL DEFAULT 0,
...
INSERT INTO `tb_surat_masuk` (`id`, `no_surat`, `tgl_surat`, `tanggal_terima`, `asal_surat`, `sifat_surat`, `perihal`, `no_agenda`, `file_surat`, `status`, `tujuan`, `kode_surat`, `undangan`, `indeks`, `disposisi`, `tahun`) VALUES
(16, '1', '2021-02-16', '2021-02-16', 3, 'sp', 'pengumuman', '0001', 'Kosong.pdf', 1, 4, 11, 0, '12', 2, '2021'),
(17, '23', '2021-02-18', '2021-02-18', 2, 'b', 'pengumuman', '0002', 'Kosong.pdf', 0, 4, 1, 0, 'penting', 0, '2021'),
(18, '23', '2021-05-11', '2021-05-12', 2, 'b', 'surat pengantar kelurahan', '0003', 'Kosong.pdf', 0, 4, 5, 0, '23', 0, '2021'),
(19, '081-1210/uk-2025', '2025-07-23', '2025-07-23', 2, 'b', 'Undangan', '0001', 'Kosong.pdf', 1, 4, 1, 1, '1', 1, '2025'),
(20, '081-1211/uang-2025', '2025-07-24', '2025-07-24', 2, 'b', 'Undangan rapat anggaran', '0002', 'Kosong.pdf', 0, 4, 1, 0, '1', NULL, '2025');
...
(4, 'Kepala Biro', '6281214600799'),
(5, 'Kabag', '6281214600799'),
(6, 'Kasubag', '6281214600799');
...
(1, 'admin', 'admin', 'admin', 'admin', 'sumbar.png', 0),
(10, 'kabiro', '123456', 'Kepala Biro', 'user', 'kabiro.png', 4),
(9, 'pbj', '123456', 'Kepala Bagian PBJ', 'user', 'user.png', 5),
(11, 'lpse', '123456', 'Kepala bagian LPSE', 'user', 'logo.png', 5),
(12, 'advokasi', '123456', 'Kepala bagian Advokasi', 'user', 'logo.png', 5),
(13, 'sub-advokasi', '123456', 'Kepala sub bagian Advokasi', 'user', 'admincewek.png', 6);
...
--
-- Indexes for table `tb_history_surat_masuk`
--
ALTER TABLE `tb_history_surat_masuk`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `m_dispos`
  MODIFY `id_dispos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `ref_klasifikasi`
--
ALTER TABLE `ref_klasifikasi`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;
...
--
ALTER TABLE `tb_asal_tujuan`
  MODIFY `id_asal_tujuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `tb_history_surat_masuk`
--
ALTER TABLE `tb_history_surat_masuk`
