        ...
        <div class="box box-success box-solid">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <a href="?page=m_dispos&aksi=tambah" class="btn btn-success" style="margin-bottom: 8px;"><i
                        ...
                        <tbody>
                            ...
                            while ($data = $sql->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?page=m_dispos&aksi=ubah&id=<?php echo $data['id_dispos']; ?>"
                                            class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Ubah</a>
                                        <a onclick="return confirm('Anda Yakin Akan Mengahapus Data Ini ... ???')"
                                            href="?page=m_dispos&aksi=hapus&id=<?php echo $data['id_dispos']; ?>"
