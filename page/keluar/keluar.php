<div class="row">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td><?php echo $data['perihal'] ?> <br> <a href="page/keluar/file_surat.php?id=<?php echo $data['no_agenda']; ?>" target="blank"><div style="color: green;"> [file: <?php echo $data['foto'];?>]</a><div></td>
